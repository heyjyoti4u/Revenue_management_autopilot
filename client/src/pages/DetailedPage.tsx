...
const revenueMetricMeta: Record<RevenueMetric, { label: string; unit: string; color: string; note: string }> = {
  revpar: { label: "RevPAR", unit: "$", color: "#f26b4f", note: "revenue per available room" },
...
// Yahan "export default" mojood hai, jo aapka build fail karwa raha tha.
